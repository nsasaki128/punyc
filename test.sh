...
assert 32 '{ int a=2; int b=3; int c=10; return a+b*c; }'
assert 3 '{ int foo=3; return foo; }'
assert 8 '{ int foo123=3; int bar=5; return foo123+bar; }'
assert 7 '{ int foo=3; int bar=2; foo=7; return foo; }'
assert 3 '{ if (0) return 2; return 3; }'
assert 3 '{ if (1-1) return 2; return 3; }'
assert 2 '{ if (1) return 2; return 3; }'
assert 2 '{ if (2-1) return 2; return 3; }'
assert 3 '{ int a=1; int b=2; if (a>b) return 2; else return 3; return 4; }'
...
assert 8 '{ int x = 3; int y = 5; return x+y; }'
